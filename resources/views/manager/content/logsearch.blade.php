        ...
        <div id="dataAndpage">
            ...
            <div style="text-align: center">
                @for($i=1;$i<=$number_page;$i++)
                    <a href="#" onclick="manage.searchPaging('{{$i}}','{{$apiname}}','{{$type_log}}','{{$message_log}}');"><span class="badge page_{{$i}}" style="background-color:#9D928C;">{{$i}}</span></a>
                @endfor
            </div>
        </div>
    </div>
