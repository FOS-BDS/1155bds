    ...
    <table class="table table-striped table-bordered">
        ...
        @foreach($rules as $rule)
            <tr>
                ...
                <td style="text-align: right;">{{$rule['odd_type']}}</td>
                <td style="text-align: center;">{{$rule['time']['type']}}</td>
                <td style="text-align: left;">{{$rule['field']}}</td>
                <td style="text-align: left;">{{$rule['operator']}}</td>
