                            ...
                            @if(isset($match_info->lastest_odd))
                                ...
                                <td>
                                    ...
                                    @if(isset($lastest_odd['1x2']))
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['1x2']['home']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['1x2']['away']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['1x2']['draw']}}</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['ah']))
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ah']['home']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ah']['away']}}</div>
                                        <div>&nbsp;</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['ou']))
                                        ...
                                        <div title="Chủ" class="hide">{{$lastest_odd['ou']['draw']}}</div>
                                        <div>&nbsp;</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['ou']))
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ou']['home']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ou']['away']}}</div>
                                        <div>&nbsp;</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['1x21st']))
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['1x21st']['home']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['1x21st']['away']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['1x21st']['draw']}}</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['ah1st']))
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ah1st']['home']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ah1st']['away']}}</div>
                                        <div>&nbsp;</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['ou1st']))
                                        ...
                                        <div title="Chủ" class="hide">{{$lastest_odd['ou1st']['draw']}}</div>
                                        <div>&nbsp;</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
                                ...
                                <td >
                                    @if(isset($lastest_odd['ou1st']))
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ou1st']['home']}}</div>
                                        <div title="Chủ" class="bold-text">{{$lastest_odd['ou1st']['away']}}</div>
                                        <div>&nbsp;</div>
                                    @else
                                        <div>&nbsp;</div>
                                        <div>&nbsp;</div>
